...
4. 连接远程github库
- git remote add origin git@github.com:xeebudong/project.git

- git clone git@github.com:xeebudong/project.git
...
5. IT IS POSSIBLE THAT SOMEONE IS DOING SOMETHING NASTY!
   ...
   [解决方案](https://blog.csdn.net/qq_43391414/article/details/121179955)：
   ...
   打开用户目录下面的.[ssh](https://so.csdn.net/so/search?q=ssh&spm=1001.2101.3001.7020)/known_hosts文件，然后删除连过这个ip地址的记录，那么下次连接的时候会认为是第一次连接，所以会重新保存指纹。
...
6. remote: error: GH001: Large files detected. You may want to try Git Large File Storage - https://git-lfs.github.com.

[解决方案](https://blog.csdn.net/qq_43827595/article/details/105673569)

> git filter-branch -f --index-filter 'git rm --cached --ignore-unmatch 6.biz/1.Finished/52.VBA透视表自动生成/每周出勤统计表-Python/build/auto_excel_dealer/auto_excel_dealer.pkg'
...
6. Fixing the “GH001: Large files detected. You may want to try Git Large File Storage.”
